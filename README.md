...
> **R:Porque lo que hizo el preprocesador fue copiar y pegar en programa.i todos los prototipos de funciones y structs que se encontraban en los headers indicados por los include al inicio del programa.c **
...
> **R:Porque no encontro alguna linea en programa.i que tenga ese patron de caracteres, hize la verficacion viendo el archivo preprocesado**
...
> **R:printf("[DEBUG] %s\n", ("Iniciando main")); fue la salida del segundo comando, el primero sin el -DDEBUG no devolvio nada **
...
> **R:Me dicen que el bloque de printf esta en la lineas 1, 28, 29, 35 y 38. El archivo del que proviene el bloque es el stdio.h**
...
> **R:.LFB6: ; .cfi_startproc ; endbr64 ; pushq   %rbp**

Explicá en términos generales qué hacen esas instrucciones
(usá los comentarios del laboratorio como guía):

> **R:Tuve que buscar que hacian estas instrucciones porque no hay comentarios relacionados. ".LFB6:" es una etiqueta pero interna del compilador; ".cfi_startproc" le dice al depurador que aca empieza la funcion; "endbr64" verifica que el flujo de ejecucion es valido y para prevenir ataques; "pushq %rbp" guarda el valor de rbp en la pila**
...
> **R:Porque en programa.c no tiene el codigo de la implementacion de la funcion area_circulo, por incluir el header de matematica.c(que tiene la implementacion) puede hacer la invocacion a esa funcion**
...
> **R:bash: ./programa.o: Permiso denegado**
